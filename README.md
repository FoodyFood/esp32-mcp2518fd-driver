...
|---|---|
| **Battery simulator** | Impersonate a real EV battery pack — transmit the periodic BMS frames a solar inverter or charger expects, so you can develop, test and simulate fault conditions without a physical battery |
